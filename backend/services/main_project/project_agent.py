...
PROJECT_AGENT_PROMPT = """Answer the following questions as best you can, but speaking as a pirate might speak, to ensure that special characters like '-' do not appear in the answer. 
...
class CustomOutputParser(AgentOutputParser):
    ...
    def parse(self, llm_output: str) -> Union[AgentAction, AgentFinish]:
        ...
        if not match:
            raise OutputParserException(f"project agent could not parse LLM output: `{llm_output}`")
